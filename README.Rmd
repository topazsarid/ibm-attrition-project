...
```{r figure1,echo=FALSE, fig.width=6.2, fig.height=4.3, fig.cap="Figure 1. Attrition rate for each strain factor. Dashed line = overall average attrition rate (16.1%)."}
...
```{r table1, echo=FALSE, message=FALSE, warning=FALSE, fig.width=6.6, fig.height=2.85}
