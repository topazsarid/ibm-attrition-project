...
```{r figure-or, fig.width=7.2, fig.height=4.2, fig.cap="Figure 2. Odds ratios from the initial logistic regression model. Points show odds ratios and lines show 95% confidence intervals."}
...
```{r table1, message=FALSE, warning=FALSE, fig.width=6.6, fig.height=2.85}
...
```{r income-seniority-table, message=FALSE, warning=FALSE, results='asis'}
library(tidyverse)
library(knitr)
